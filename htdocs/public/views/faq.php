...
<div class="modal-inner-content modal-inner-content-about" style="padding-bottom: 30px;">
    <div class="modal-inner-content-menu">
        ...
        <?php if (getWebsiteConfig('ogn_is_status_url')): ?><a href="/views/server_health.php?server=ogn" class="tdlink" title="OGN Server Health">OGN Server Health</a><?php else: ?><span>OGN Server Health</span><?php endif; ?>
        <?php if (getWebsiteConfig('cbaprs_is_status_url')): ?><a href="/views/server_health.php?server=cbaprs" class="tdlink" title="CBPARS Server Health">CBAPRS Server Health</a><?php else: ?><span>CBAPRS Server Health</span><?php endif; ?>
    </div>
